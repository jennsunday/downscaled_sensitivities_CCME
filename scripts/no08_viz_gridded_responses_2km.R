#goal subset to speices present at the depth of that grid cell
...
test<-data.frame(modelzone=c("bot", "bot", "surf", "surf", "200", "200"), 
                 depth=c(10, 100, 10, 100, 10, 100), 
                 lower_depth=c(50, 50, 50, 50, 50, 50))
test %>%
  filter(modelzone != "bot" | lower_depth>depth)
View(pos_neg_grid)a

sensitivity_by_study$lower_depth
all_deltas_2km$depth
