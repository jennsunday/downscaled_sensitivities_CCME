...
little_relevant_layer<-rbind(littletempbot_responses_long %>%
...
big_relevant_layer<-rbind(bigtempbot_responses_long %>%
                               filter(species %in% c("seagrass", 
                                                     "CanopyformingKelp", 
                                                     "Ochrestar",
                                                     "Dungenesscrab",
...
ggsave("figures/bigtemp_layer_response.pdf", height = 6, width = 9)
