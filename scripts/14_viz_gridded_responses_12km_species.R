...
# separated by species, for the 12km model
...
all_cells_deltas_12km<-all_deltas_12km %>%
...
#get coastline mask
coastline_mask2<-read_csv("processed_data/coastline_mask_12km.csv")
...
#pos_neg_grid_shelf<-left_join(pos_neg_grid, shelf_contour_12km, by=(c("lat", "long"))) %>%
#  filter(shelf!=0)
...
ggsave("figures/pos_neg_species_beside_12km.png", height=5, width=5)
ggsave("figures/pos_neg_species_beside_12km.pdf", height=5, width=5)
