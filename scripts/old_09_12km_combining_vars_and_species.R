...
oxy200_greater_than_10percent<-read_csv("processed_data/big_oxy200_greater_than_10percent.csv")
oxybot_greater_than_10percent<-read_csv("processed_data/big_oxybot_greater_than_10percent.csv")
CO2200_greater_than_10percent<-read_csv("processed_data/big_CO2200_greater_than_10percent.csv")
CO2bot_greater_than_10percent<-read_csv("processed_data/big_CO2bot_greater_than_10percent.csv")
temp200_greater_than_10percent<-read_csv("processed_data/big_temp200_greater_than_10percent.csv")
tempbot_greater_than_10percent<-read_csv("processed_data/big_tempbot_greater_than_10percent.csv")
...
all_vars_together_bot %>% 
  ...
  facet_wrap(~species2, nrow=2) +
  geom_text(data=num_studs, aes(x=165, y=15, label=all_var_num_responses))
ggsave("figures/big_all_vars_together_bot_10percent.pdf", height = 6, width = 9)
